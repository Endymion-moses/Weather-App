...
const HourlyForecast = () => {
    ...
    if (!city) {
        return (
            <div className='p-10'>
                <div className='flex inline-block border border-blue-600 bg-blue-600 rounded-2xl justify-center items-center w-full pr-10 p-5'>
                    <div className='w-full text-center'>
                        <h1 className='text-white text-4xl p-4 pl-8'>Hourly Forecast</h1>
                        <h2 className='text-white text-2xl mt-4'>Loading hourly forecast</h2>
                    </div>
                </div>
            </div>
        )
            ...
            <div className='flex inline-block border border-blue-600 bg-blue-600 rounded-2xl justify-center items-center w-full pr-10 p-5'>
                ...
                <div className='p-5 flex gap-4 justify-center items-center'>
                    {forecast.map((f, index) => (
                        <div className='flex inline-block border border-blue-500 bg-blue-500 rounded-2xl p-3 justify-center items-center p-10 flex-l' key={index}>
                            <h3 className='text-white'>{f.time}</h3>
