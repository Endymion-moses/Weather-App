           ...
           <div className='p-5 '>
            ...
            bg-blue-500 rounded-2xl p-4 hover:scale-105 hover:bg-blue-300'>
                ...
                <div className='flex text-left'>
                        <h3 key = {index} className='text-white'>{Data.day}</h3>
                        <h3 key = {index} className='text-white'>{Data.condition}</h3>
               </div>
                <div className='flex text-right'>
                        <h3 key = {index} className='text-white'>{Data.highTemp}</h3>
                        <h3 key = {index}  className='text-white'>{Data.lowTemp}</h3>
                </div>
           </div>
           </div>
